...
const Login = () => {
  ...
  return (
    <div style={{background:`url(${bg}) no-repeat center/cover`}}  className="h-[100dvh] flex justify-center items-center">
      <form onSubmit={handleSubmit} className="bg-[rgba(255,255,255,0.1)] shadow-[0_0_.5rem_#262626] p-4 px-8 rounded-lg hover:shadow-[0_0_.8rem_#262626] transition-shadow duration-200">
        ...
        >
          {
            loading ? <Loader/> : <span className="font-bold tracking-wide hover:tracking-widest transition-all duration-500">Login</span>
          }
        </button>
        <p className="text-center my-4 text-[#262626]">
          Not having an account?{" "}
          <Link className="underline text-[#3b2559] hover:no-underline" to="/signup">
            Signup
          </Link>{" "}
        </p>
      </form>
